...
class Parameters:
    def __init__(self):
        self.base_dir = 'data'
        self.dir_character_annotations='antrenare'
        ...
        self.dir_test_examples = os.path.join('testare') #self.base_dir, 'exempleTest/CMU+MIT'
        self.path_annotations = os.path.join('validare/task1_gt_testare.txt')#self.base_dir, 'exempleTest/CMU+MIT_adnotari/ground_truth_bboxes.txt'
